...
namespace QRCoder
{
	public class QRCodeGenerator
	{
		...
		private static readonly Dictionary<char, int> alphanumEncDict = alphanumEncTable.Select((x, i) => new { Chr = x, Index = i }).ToDictionary(x => x.Chr, x => x.Index);
		...
		{
			var alignmentPatternTable = new List<AlignmentPattern>();
		...
		{
			var capacityECCTable = new List<ECCInfo>();
		...
		{
			var capacityTable = new List<VersionInfo>();
		...
		{
			var galoisField = new List<Antilog>();
